...
async def crawl_data(session, url):
    async with session.get(url) as response:
        ...
        publish_date = soup.find('time', {'itemprop': 'datePublished'})
        year = publish_date['datetime'][:4] if publish_date and 'datetime' in publish_date.attrs else (publish_date.text.strip() if publish_date else "Unknown")
        genres = [g.text.strip() for g in soup.find_all('a', {'class': 'tag'})]
        pages = soup.find('span', {'itemprop': 'numberOfPages'}).text.strip() if soup.find('span', {'itemprop': 'numberOfPages'}) else "Unknown"
...
# def initialize_book_data():
    book_urls = [
        ...
        "https://openlibrary.org/works/OL67890W",
        "https://openlibrary.org/books/OL35649409M",
        "https://openlibrary.org/books/OL40295210M",
        "https://openlibrary.org/works/OL40295210M",
        "https://openlibrary.org/works/OL7870148M",
        "https://openlibrary.org/works/OL1100007W",
        "https://openlibrary.org/works/OL33874740M",
        "https://openlibrary.org/works/OL6927336M",
        "https://openlibrary.org/works/OL27468204W",
        "https://openlibrary.org/works/OL450063W",
        "https://openlibrary.org/works/OL64365W",
        "https://openlibrary.org/works/OL1548597W",
        "https://openlibrary.org/works/OL1100007W",
        "https://openlibrary.org/works/OL52266W",
        "https://openlibrary.org/works/OL27468204W",
        "https://openlibrary.org/works/OL15678068W",
        "https://openlibrary.org/works/OL381550W",
        "https://openlibrary.org/works/OL27467443W",
        "https://openlibrary.org/works/OL7574091W",
        "https://openlibrary.org/works/OL3639910W",
        "https://openlibrary.org/works/OL66059W",
        "https://openlibrary.org/works/OL1892617W",
        "https://openlibrary.org/works/OL24446425W",
        "https://openlibrary.org/works/OL1068214W",
        "https://openlibrary.org/works/OL15116693W",
        "https://openlibrary.org/works/OL8894965W",
        "https://openlibrary.org/works/OL1214190W",
        "https://openlibrary.org/works/OL21015217W",
        "https://openlibrary.org/works/OL14903327W",
        "https://openlibrary.org/works/OL18407621W",
        "https://openlibrary.org/works/OL515051W",
        "https://openlibrary.org/works/OL723491W",
        "https://openlibrary.org/works/OL69382W",
        "https://openlibrary.org/works/OL1356870W",
        "https://openlibrary.org/works/OL1151518W",
        "https://openlibrary.org/works/OL28988W",
        "https://openlibrary.org/works/OL14903351W",
